        ...
        if (static::$helperInitialized === false) {   
            ...
            //if(defined(Constants::WP_CONFIG_DEBUG) && constant(Constants::WP_CONFIG_DEBUG) === true && WP::getOption(Constants::QUICK_404_OPTION, false) === true) {
                ...
                static::addAction("template_redirect", function($template) {
                    ...
                    if(is_404() && !PHP::toBool(PHP::filterInput('wp-helper-disable-quick-404', [ INPUT_GET ], FILTER_DEFAULT /* FILTER_VALIDATE_BOOLEAN */))) {
                        ...
                        wp_die(
                            "This is a replacement 404 page generated by <a target=\"_blank\" href=\"{$wpHelperPath}\">WP Helper</a> <br /><br /> To disable: either set <strong>WP_DEBUG</strong> to <em>false</em> or <a target=\"_blank\" href=\"{$wpHelperSettingsPath}\">go to the settings page</a>. <br /><br /> To see the original template, please <a href=\"$unblockedUri\">click here</a>.",
                            "404 Not Found",
