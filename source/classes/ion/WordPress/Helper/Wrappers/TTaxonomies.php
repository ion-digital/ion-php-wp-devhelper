        ...
        static::registerWrapperAction('init', function() {            
            ...
            foreach(static::$taxonomies as $taxonomySlug => $taxonomy) {
                ...
                $args = [
                    ...
                    'show_tagcloud' => $taxonomy['showTagcloud'],
                    'show_in_quick_edit' => $taxonomy['showInQuickEdit'],
                    'meta_box_cb' => ($taxonomy['registerMetaBox'] === true ? $taxonomy['metaBoxCallback'] : false),
                    'show_admin_column' => $taxonomy['showAdminColumn'],
                    'description' => $taxonomy['description'],
                    'hierarchical' => ($taxonomy['hierarchical'] === null ? false : $taxonomy['hierarchical']), 
                    'update_count_callback' => $taxonomy['updateCountCallback'],
                    ...
                    'rewrite' => (PHP::isEmpty($taxonomy['rewrite']) ? null : [
                        ...
                        'hierarchical' => $taxonomy['rewriteHierarchical'],
