...
final class WordPressHelper implements WordPressHelperInterface
{
     ...
     * @return void
     */
    private static function registerWrapperAction($actionName, callable $init, $priority = self::DEFAULT_WRAPPER_PRIORITY, $returnFirstResult = false)
    {
     ...
     * @return void
     */
    private static function initializeHelper(HelperContextInterface $context, array $wpHelperSettings, $helperDir = null)
    {
...
TEMPLATE;
     ...
     */
    public static function createContext($vendorName, $projectName, $loadPath, $helperDir = null, array $wpHelperSettings = null, SemVerInterface $version = null, callable $construct = null, callable $initialize = null, callable $activate = null, callable $deactivate = null, array $uninstall = null)
    {
     ...
     * @return mixed
     */
    protected function __construct($vendorName, $projectName, $loadPath, $helperDir = null, array $wpHelperSettings = null, SemVerInterface $version = null, callable $construct = null, callable $initialize = null, callable $activate = null, callable $deactivate = null, array $uninstall = null)
    {
