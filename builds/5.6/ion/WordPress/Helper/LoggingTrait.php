...
trait LoggingTrait
{
    ...
    public static function registerLog($slug, $name = null)
    {
        ...
        if (!array_key_exists($slug, static::$logs)) {
            $log = new WordPressHelperLog($slug, $name, (bool) static::getSiteOption(Constants::ENABLE_LOGGING, false), (bool) static::getSiteOption(Constants::LOG_TO_DATABASE, false), (int) static::getSiteOption(Constants::LOGS_PURGE_AGE, 90));
