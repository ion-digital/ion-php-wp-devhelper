...
TEMPLATE;
    ...
    public function readFromOptions($optionName = null)
    {
        $self = $this;
        if ($optionName !== null) {
            return $this->onRead(function ($record = null, $key = null, $metaId = null, $type = null) use($self, $optionName) {
        ...
        return $this->onRead(function ($record = null, $key = null, $metaId = null, $type = null) use($self) {
            $result = null;
    ...
    public function updateToOptions($optionName = null)
    {
        ...
        return $this->onUpdate(function ($index, $newValues, $oldValues, $key = null, $metaId = null, $type = null) use($self) {
            $options = [];
