...
class AdminFormHelper implements IAdminFormHelper
{
    ...
    private function renderRows(array &$state, $columns, array $rows, array $data = null, $postId = null)
    {
        $output = "";
        //        var_Dump($data);
        foreach ($rows as $row) {
...
TEMPLATE;
    ...
    public function setRawOptionOperations($raw)
    {
        $this->raw = $raw;
        return $this;
    }
    ...
    public function getRawOptionOperations()
    {
        return $this->raw;
    }
    ...
    public function readFromOptions($optionName = null)
    {
        $self = $this;
        if ($optionName !== null) {
            return $this->read(function ($record = null, $key = null, $metaId = null, $type = null) use($self, $optionName) {
        ...
        return $this->read(function ($record = null, $key = null, $metaId = null, $type = null) use($self) {
            $result = null;
    ...
    public function updateToOptions($optionName = null)
    {
        $self = $this;
        if ($optionName !== null) {
            return $this->update(function ($index, $newValues, $oldValues, $key = null, $metaId = null, $type = null) use($self, $optionName) {
                $optionRecords = WP::getOption($optionName, [], $metaId, $type, $this->getRawOptionOperations());
        ...
        return $this->update(function ($index, $newValues, $oldValues, $key = null, $metaId = null, $type = null) use($self) {
            $options = [];
    ...
    public function createToOptions($optionName = null)
    {
        $self = $this;
        if ($optionName !== null) {
            return $this->create(function (array $values, $key = null, $metaId = null, $type = null) use($optionName) {
                $optionRecords = WP::getOption($optionName, [], $metaId, $type, $this->getRawOptionOperations());
