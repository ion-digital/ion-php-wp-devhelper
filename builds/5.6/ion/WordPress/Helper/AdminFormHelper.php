...
class AdminFormHelper implements AdminFormHelperInterface
{
     ...
     * @return array
     */
    public static function createGroupDescriptorInstance($title = null, $description = null, $id = null, $columns = null)
    {
     ...
     * @return string
     */
    public function processAndRender($echo = true, $post = null)
    {
        $this->process($post);
     ...
     * @return mixed
     */
    private function renderRows(array &$state, $columns, array $rows, array $data = null, $metaId = null)
    {
        $output = "";
        //        var_Dump($data);
        foreach ($rows as $row) {
...
TEMPLATE;
        ...
        foreach ($this->descriptor["groups"] as $group) {
            ...
            if ($group["title"] !== null && $this->descriptor["groups"][0]["title"] !== null && PHP::count($this->descriptor["groups"]) > 1 && $visibleFields > 0) {
...
TEMPLATE;
     ...
     * @return bool
     */
    public function getUseSerialization()
    {
    ...
    public function readFromOptions($optionName = null)
    {
        $self = $this;
        if ($optionName !== null) {
            return $this->onRead(function ($record = null, $key = null, $metaId = null, $type = null, array $descriptor = []) use($self, $optionName) {
        ...
        return $this->onRead(function ($record = null, $key = null, $metaId = null, $type = null, array $descriptor = []) use($self) {
            $result = null;
    ...
    public function updateToOptions($optionName = null)
    {
        $self = $this;
        if ($optionName !== null) {
            return $this->onUpdate(function ($index, $newValues, $oldValues, $key = null, $metaId = null, $type = null) use($self, $optionName) {
                //                        $optionRecords = WP::getOption($optionName, [], $metaId, $type, $this->getRawOptionOperations());
                $optionRecords = $this->getOption($optionName, [], $metaId, $type);
        ...
        return $this->onUpdate(function ($index, $newValues, $oldValues, $key = null, $metaId = null, $type = null, array $descriptor = []) use($self) {
            $options = [];
    ...
    public function createToOptions($optionName = null)
    {
        $self = $this;
        if ($optionName !== null) {
            return $this->onCreate(function (array $values, $key = null, $metaId = null, $type = null) use($optionName) {
                //                        $optionRecords = WP::getOption($optionName, [], $metaId, $type, $this->getRawOptionOperations());
                $optionRecords = $this->getOption($optionName, [], $metaId, $type);
