...
TEMPLATE;
    ...
    public static function dropDownListInputField($label, array $values, $name = null, $value = null, $id = null, $hint = null, $emptyMessage = null, callable $modifyValues = null, $span = false, $readOnly = false, $disabled = false, $echo = false)
    {
        $name = $name !== null ? $name : static::slugify($label);
        $id = $id !== null ? $id : static::slugify($name) . '-field';
        $field = ['type' => 'DropDown', "label" => $label, "name" => $name, "id" => $id, "hint" => $hint, "html" => null, "span" => $span, 'readOnly' => $readOnly, 'disabled' => $disabled, "post" => function ($postValue = null) {
...
TEMPLATE;
    ...
    public static function button($label, $id = null, $hint = null, IAdminFormHelper $form = null, $span = false, $disabled = false, $javaScript = null, $echo = true)
    {
        ...
        $button["html"] = function ($value = null, $keyName = null, $keyValue = null, $nameOverride = null) use($button, $form, $javaScript, $id) {
            // The following values are NOT applied to the field array - they are temporarily modified here
...
JS
    ...
    public static function notify($message, $notice = "notice-info", $dismissable = false, $echo = false)
    {
