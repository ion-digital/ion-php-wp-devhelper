...
trait OptionsTrait
{
    ...
    public static function setSiteOption(
        string $name,
        /* mixed */
        $value = null,
        bool $autoLoad = false
    ...
    public static function getPostOption(
        string $name,
        int $metaId,
        /* mixed */
        $default = null
    ...
    public static function setPostOption(
        string $name,
        int $metaId,
        /* mixed */
        $value = null,
    ...
    public static function getTermOption(
        string $name,
        int $metaId,
        /* mixed */
        $default = null
    ...
    public static function setTermOption(
        string $name,
        int $metaId,
        /* mixed */
        $value = null,
    ...
    public static function setUserOption(
        string $name,
        int $metaId,
        /* mixed */
        $value = null,
    ...
    public static function setCommentOption(
        string $name,
        int $metaId,
        /* mixed */
        $value = null,
    ...
    public static function getCustomizationOption(
        string $name,
        /* mixed */
        $default = null
    )
    ...
    public static function setCustomizationOption(
        string $name,
        /* mixed */
        $value = null
    ) : void
