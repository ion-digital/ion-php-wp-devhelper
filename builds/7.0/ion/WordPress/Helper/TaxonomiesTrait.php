...
trait TaxonomiesTrait
{
     ...
     * @return void
     */
    public static function addTaxonomy(string $slug, string $pluralLabel, string $singularLabel, array $postTypes = null, string $description = null, bool $registerMetaBox = true, callable $metaBoxCallback = null, bool $hierarchical = null, bool $sort = null, array $labels = null, bool $public = null, bool $publiclyQueryable = null, bool $showUi = null, bool $showInNavMenus = null, bool $showInMenu = null, bool $showTagcloud = null, bool $showInQuickEdit = null, bool $showAdminColumn = null, array $capabilities = null, bool $rewrite = null, string $rewriteSlug = null, bool $rewriteWithFront = null, bool $rewriteHierarchical = null, string $rewriteEndPointMask = null, bool $enableQueryVar = null, string $queryVar = null, bool $showInRest = null, string $restBase = null, string $restControllerClass = null, callable $updateCountCallback = null)
    {
        if (PHP::isEmpty($slug)) {
        ...
        $args = array_filter(['label' => $pluralLabel, 'labels' => array_filter($labels, function ($value) {
            return $value !== null;
        }), 'public' => $public === null ? true : $public, 'publicly_queryable' => $publiclyQueryable === null ? false : $publiclyQueryable, 'show_ui' => $showUi === null ? true : $showUi, 'show_in_menu' => $showInMenu === null ? true : $showInMenu, 'show_in_nav_menus' => $showInNavMenus === null ? true : $showInNavMenus, 'show_in_rest' => $showInRest === null ? true : $showInRest, 'rest_base' => $restBase, 'rest_controller_class' => $restControllerClass, 'show_tagcloud' => $showTagcloud, 'show_in_quick_edit' => $showInQuickEdit, 'meta_box_cb' => $registerMetaBox === true ? $metaBoxCallback : false, 'show_admin_column' => $showAdminColumn, 'description' => $description, 'hierarchical' => $hierarchical === null ? false : $hierarchical, 'update_count_callback' => $updateCountCallback, 'query_var' => PHP::isEmpty((bool) $enableQueryVar) ? false : (string) $queryVar, 'rewrite' => PHP::isEmpty($rewrite) ? null : array_filter(['slug' => $rewriteSlug, 'with_front' => $rewriteWithFront, 'hierarchical' => $rewriteHierarchical, 'ep_mask' => $rewriteEndPointMask], function ($value) {
            return $value !== null;
        }), 'capabilities' => $capabilities, 'sort' => $sort], function ($value) {
            return $value !== null;
        });
     ...
     * @return void
     */
    public static function addPostTypesToTaxonomy(string $taxonomy, array $postTypes)
    {
        foreach ($postTypes as $postType) {
     ...
     * @return ?string
     */
    public static function getTaxonomyFromTerm(string $termSlug)
    {
        global $wpdb;
        $sql = <<<SQL
...
SQL;
     ...
     * @return ?WP_Term
     */
    public static function getTermParent(int $termId)
    {
