...
JS;
     ...
     * @return void
     */
    public static function addScript(string $id, string $src, bool $backEnd = true, bool $frontEnd = false, bool $inline = false, bool $addToEnd = false, int $priority = 1, SemVerInterface $version = null, array $dependencies = [])
    {
     ...
     * @return void
     */
    public static function addStyle(string $id, string $src, bool $backEnd = true, bool $frontEnd = false, bool $inline = false, string $media = "screen", int $priority = 1, SemVerInterface $version = null, array $dependencies = [])
    {
