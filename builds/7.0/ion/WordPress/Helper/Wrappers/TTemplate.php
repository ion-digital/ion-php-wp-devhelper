...
trait TTemplate
{
    ...
    public static function addMenu(string $id, string $description = null)
    {
    ...
    public static function getCurrentTemplateObjectId(bool $ignoreTheLoop = false)
    {
        if (WP::isAdmin()) {
            return null;
        }
    ...
    public static function getCurrentTemplateObjectType(bool $ignoreTheLoop = false)
    {
        if (WP::isAdmin()) {
            return null;
        }
