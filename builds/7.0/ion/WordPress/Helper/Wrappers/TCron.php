...
trait TCron
{
    ...
    public static function addCronJob(string $name, int $startTimeStamp, string $intervalName, callable $job)
    {
    ...
    public static function removeCronJob(string $name)
    {
