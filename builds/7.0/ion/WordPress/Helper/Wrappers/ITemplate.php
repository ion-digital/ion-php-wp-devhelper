...
interface ITemplate
{
     ...
     * @return ?string
     */
    static function getCurrentTemplateObjectType(bool $ignoreTheLoop = false);
    /**
     * method
     * 
     * 
     * @return ?object
     */
    static function getCurrentTemplateObject(bool $ignoreTheLoop = false);
    /**
     * method
     * 
     * 
     * @return ?int
     */
    static function getCurrentTemplateObjectId(bool $ignoreTheLoop = false);
    // --- Deprecated ---
    /**
     * method
     * 
