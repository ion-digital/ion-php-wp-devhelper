...
class WordPressPostType implements WordPressPostTypeInterface
{
     ...
     * @return ?int
     */
    public function setMenuPosition(int $menuPosition = null)
    {
     ...
     * @return ?string
     */
    public function setMenuIcon(string $menuIcon = null)
    {
     ...
     * @return ?string
     */
    public function setSingleCapabilityType(string $singleCapabilityType = null)
    {
     ...
     * @return ?string
     */
    public function setPluralCapabilityType(string $pluralCapabilityType = null)
    {
     ...
     * @return ?string
     */
    public function setRewriteEndPointMask(string $rewriteEndPointMask = null)
    {
     ...
     * @return ?string
     */
    public function setQueryVar(string $queryVar = null)
    {
